...
```{r, fig.show="hold", out.width="50%", fig.cap='Pogostost spletnega nakupovanja'}
pogostost %>% 
...
```{r, fig.align='center', fig.cap='Podatki o vrstah blaga / storitev'}
...
```{r, out.width="50%", fig.cap='Vrednosti skupnih spletnih nakupov'}
urejene_vrednosti %>% 
...
```{r , fig.align='center', fig.cap= 'Težave pri spletnem nakupovanju'}
tezave %>%
